...
execute at @s[scores={tickle=1}] run summon minecraft:silverfish ~ ~ ~ {CustomName:'[{"text":"Tactical Tickle"}]',HandItems:[{id:"feather",tag:{name:Tickle},Count:1}],HandDropChances:[10.0F],Tags:["RoW"]}
execute at @s[scores={tickle=1}] run summon minecraft:silverfish ~ ~ ~ {CustomName:'[{"text":"Tactical Tickle"}]',HandItems:[{id:"feather",tag:{name:Tickle},Count:1}],HandDropChances:[10.0F],Tags:["RoW"]}
execute at @s[scores={tickle=1}] run summon minecraft:silverfish ~ ~ ~ {CustomName:'[{"text":"Tactical Tickle"}]',HandItems:[{id:"feather",tag:{name:Tickle},Count:1}],HandDropChances:[10.0F],Tags:["RoW"]}
execute at @s[scores={tickle=1}] run summon minecraft:silverfish ~ ~ ~ {CustomName:'[{"text":"Tactical Tickle"}]',HandItems:[{id:"feather",tag:{name:Tickle},Count:1}],HandDropChances:[10.0F],Tags:["RoW"]}
execute at @s[scores={tickle=1}] run summon minecraft:silverfish ~ ~ ~ {CustomName:'[{"text":"Tactical Tickle"}]',HandItems:[{id:"feather",tag:{name:Tickle},Count:1}],HandDropChances:[10.0F],Tags:["RoW"]}
