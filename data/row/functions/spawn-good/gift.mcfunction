...
execute store success score @s gift run setblock ~1 ~ ~ minecraft:chest{LootTable:"row:row/gift"}
execute store success score @s gift if score @s gift matches 0 run setblock ~-1 ~ ~ minecraft:chest{LootTable:"row:row/gift"}
execute store success score @s gift if score @s gift matches 0 run setblock ~ ~ ~1 minecraft:chest{LootTable:"row:row/gift"}
execute store success score @s gift if score @s gift matches 0 run setblock ~ ~ ~-1 minecraft:chest{LootTable:"row:row/gift"}
execute store success score @s gift if score @s gift matches 0 run setblock ~ ~ ~ minecraft:chest{LootTable:"row:row/gift"}
